...
class Clients(pcsw.Clients):  # see blog 2013/0817
    ...
    def client_info(cls, self, ar):
        ...
        elems += [self.first_name, ' ',
                  ar.obj2html(self, self.last_name), E.br()]
        ...
        elems = [
            E.div(*elems, style="font-size:18px;font-weigth:bold;vertical-align:bottom;text-align:middle")]
...
class CoachingsByClient(pcsw.CoachingsByClient):
    ...
    def actions(cls, obj, ar):
        elems = []
        elems += [ar.instance_action_button(obj.create_visit,
