...
Newcomers consultants."""),
    'welfare.pcsw.PersonGroup' : _("""TODO: Rename this table to IntegrationPhase."""),
    ...
    'welfare.isip.ContractPartner.company' : _("""Pointer to the contacts.Company"""),
...
field filled in."""),
    ...
    'welfare.cv.CefLevel' : _("""List of possible choices for the
LanguageKnowledge.cef_level field."""),
...
IncomeConfirmation as confirmation_type."""),
    'welfare.isip.ContractPartner' : _("""Every contract can optionally be associated to one or several
...
(Curriculum Vitaes)."""),
    'welfare.pcsw.Activity' : _("""Used only in Welfare à la Eupen"""),
...
lino_xl.lib.reception.models.create_prompt_event()."""),
    ...
    'welfare.isip.ContractEndings' : _("""Expresses how a contract was ended."""),
...
defined on the excerpt type."""),
    ...
    'lino_welfare.modlib.pcsw.models.RefuseClient' : _("""This is not a docstring"""),
...
guests. Ask confirmation naming the guests who need to check out."""),
    ...
    'welfare.pcsw.ClientStates' : _("""The list of possible choices for the Client.client_state field.
...
your application.  Default value is 'contacts.Person'."""),
    ...
    'welfare.isip.ContractType.exam_policy' : _("""The default ExamPolicy for new contracts of this type."""),
...
lino_welfare.modlib.cbss.choicelists.QueryRegisters"""),
    ...
    'draft' : _("""Draft vouchers can be modified but are not yet visible as movements
in the ledger."""),
...
ConfirmationTypes."""),
    'welfare.isip.ContractBase.exam_policy' : _("""Pointer to the ExamPolicy. This field tells Lino how many
automatic calendar events to generate for evaluation meetings."""),
    ...
    'welfare.isip.ContractPartner.contact_role' : _("""Pointer to the role (contacts.RoleType) of
contact_person within company."""),
...
language."""),
    'lino_welfare.modlib.jobs.models.Contract' : _("""A Contract"""),
...
not."""),
    'welfare.isip.ContractBase' : _("""Common base class for both welfare.isip.Contract and
welfare.jobs.Contract"""),
...
the person linked to this note."""),
    ...
    'welfare.isip.ContractType.ref' : _("""Print templates may use this field to conditionally hide or show
certain parts."""),
...
ContractEnding."""),
    ...
    'welfare.isip.ContractEvents' : _("""A list of the possible things that people might want to observe
...
can assign coaches to clients."""),
    ...
    'welfare.isip.ContractPartner.duties_company' : _("""Text fragment inserted into the printable document."""),
...
warn_expiry_unit."""),
    ...
    'signed' : _("""The Signed state is similar to registered, but cannot usually be
...
to security advisors)."""),
    ...
    'cancelled' : _("""Cancelled is similar to Draft, except that you cannot edit the
...
AidType instance."""),
    'welfare.pcsw.Coaching' : _("""A coaching is when a social agent assumes reponsibilty for a
...
for which the budget has been established."""),
    'welfare.reception.CreateCoachingVisit' : _("""Create a prompt event for this client with this coach."""),
...
(RefundConfirmation.pharmacy)."""),
    'welfare.cv.LanguageKnowledge' : _("""The CEF level."""),
...
be selected manually."""),
    'welfare.courses.CourseProvider' : _("""Inherits from ml.contacts.Partner."""),
    ...
    'welfare.isip.ExamPolicies' : _("""The examination policy of a contract expresses how often the
social agent meets with the client in order to analyze the
evolution of the project.  This is a ml.cal.RecurrenceSet
...
account."""),
    ...
    'welfare.isip.ContractType.full_name' : _("""An optional full title of the contract as printed on the document.
Example:"""),
    'lino_welfare.modlib.cbss.mixins.WithPerson.last_name' : _("""Last name (family name)."""),
    'welfare.isip.Contract' : _("""Inherits from ContractBase."""),
...
Miscellaneous panel."""),
    'welfare.isip.ContractPartner.contact_person' : _("""Pointer to the contacts.Person who represents this company."""),
...
lino_welfare.modlib.cbss.fixtures.sectors."""),
    'welfare.isip.Contract.study_type' : _("""Pointer to the StudyType"""),
...
period."""),
    'welfare.pcsw.Clients' : _("""Usage examples see also Filtering clients."""),
...
corps et de biens, Getrennt von Tisch und Bett)"""),
    'welfare.isip.ContractBase.client' : _("""Pointer to the welfare.pcsw.Client with whom this
contract is signed."""),
...
contract."""),
    ...
    'registered' : _("""Registered vouchers cannot be modified, but are visible as
...
selecting an aid type."""),
    'welfare.isip.ContractBase.user' : _("""The responsible integration agent."""),
    'lino_welfare.modlib.art61.models.ContractsByClient.master' : _("""alias of Client"""),
    'welfare.pcsw.ClientContact' : _("""A typed link between a Client and a an external partner
(a ml.contacts.Company and/or a
ml.contacts.Person)."""),
...
lino_welfare.modlib.cbss.choicelists.ManageActions"""),
    ...
    'welfare.isip.ContractBase.user_asd' : _("""The responsible general social agent (if there is any)."""),
...
the client's scholar education."""),
    'welfare.pcsw.AidType' : _("""TODO: Remove this table and replace it by welfare.aids."""),
...
service or a private company."""),
    ...
    'welfare.cbss.cbss.RetrieveTIGroupsRequest' : _("""Here is an incomplete list (conversion in progress) of the
