...
class LanguageKnowledge(dd.Model):
    ...
    spoken = dd.HowWell.field(_("Spoken"), blank=True)
    written = dd.HowWell.field(_("Written"), blank=True)
    spoken_passively = dd.HowWell.field(_("Spoken (passively)"),
                                        blank=True)
    written_passively = dd.HowWell.field(_("Written (passively)"),
                                         blank=True)
