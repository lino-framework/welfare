...
- users.User : id, modified, created, password, last_login, username, profile, initials, first_name, last_name, email, remarks, language, partner, coaching_type, coaching_supervisor, newcomer_consultations, newcomer_appointments, mail_mode, access_class, event_type, calendar, newcomer_quota
