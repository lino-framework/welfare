...
- users.User : id, email, language, modified, created, password, last_login, username, profile, initials, first_name, last_name, remarks, partner, newcomer_consultations, newcomer_appointments, notify_myself, mail_mode, access_class, event_type, calendar, coaching_type, coaching_supervisor, newcomer_quota
