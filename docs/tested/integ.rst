...
This call is generated by
:meth:`lino.core.actor.Actor.workflow_buttons`, which calls
:meth:`lino.core.requests.ActionRequest.action_button`. Which is where
we had a bug on :blogref:`20150515`.
