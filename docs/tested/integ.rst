...
>>> print(links[0].get('href'))
... #doctest: +NORMALIZE_WHITESPACE
javascript:Lino.newcomers.AvailableCoachesByClient.assign_coach.run(null,{ "record_id": 6, "field_values": { "notify_body": "BASTIAENSEN Laurent (116) wird ab jetzt begleitet f\u00fcr Finanzielle Begleitung durch Alicia Allmanns.", "notify_subject": "BASTIAENSEN Laurent (116) zugewiesen zu Alicia Allmanns", "notify_silent": false }, "param_values": { "since": "15.04.2014", "for_clientHidden": null, "for_client": null }, "base_params": { "mt": 58, "mk": 116 } })
