...
>>> ia_user_type = auth.UserTypes.get_by_value('100')
>>> print(ia_user_type)
Integration agent

>>> rc_user_type = auth.UserTypes.get_by_value('210')
>>> print(rc_user_type)
Reception clerk
...
>>> theresia = auth.User.objects.get(username="theresia")
...
... #doctest: +NORMALIZE_WHITESPACE
[ general_panel944, contact_panel972, coaching_panel1205, aids_tab_panel1301, work_tab_1_panel1330, history_panel2063 ]
